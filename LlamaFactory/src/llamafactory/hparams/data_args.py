...
class DataArguments:
    ...
    use_span_masking: bool = field(
        default=False,
        metadata={
            "help": "Whether or not to use span-based token masking based on answer_spans field in dataset."
        },
    )
    mask_span_types: str = field(
        default=None,
        metadata={
            "help": "Comma-separated list of span types to mask. If None, all span types will be masked."
        },
    )
    ...
    def __post_init__(self):
        ...
        self.mask_span_types = (
            split_arg(self.mask_span_types) if self.mask_span_types else None
        )
