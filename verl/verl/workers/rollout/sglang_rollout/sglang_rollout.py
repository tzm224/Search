...
import asyncio
import logging
logging.getLogger("sglang").setLevel(logging.WARNING)  # warning
...
from verl.workers.rollout.sglang_rollout.parse_utils import DrTuluFunctionCallParser  # 自定义的toolparser
...
class SGLangRollout(BaseRollout):
    ...
    def _initialize_tools(self, config, processing_class):
        ...
        # )
        # custom FunctionCallParser
        function_call_parser = DrTuluFunctionCallParser(sgl_tools)
        ...
        **kwargs,
        ...
        while current_turns < self.config.multi_turn.max_assistant_turns:
            if _req.state == AsyncRolloutRequestStateEnum.PENDING:
                ...
                # 工具调用代码
                # _req.messages[-1].tool_calls是一个list
